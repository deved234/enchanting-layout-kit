      ...
      <main className="pt-20">
        ...
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden py-20 md:py-40 sm-hero-gradient">
          <div className="container mx-auto px-5 md:px-8 relative z-10 text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 sm-glass rounded-full text-brand-pulse mb-8 border border-brand-pulse/10">
            ...
            <h1 className="text-[40px] md:text-[64px] font-bold leading-tight max-w-4xl mx-auto mb-8 tracking-tight">
              نحول خيالك إلى <span className="text-brand-pulse inline-block">واقع ملموس</span>
            </h1>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4">
              <a className="w-full md:w-auto px-10 py-5 sm-primary-gradient text-white font-bold rounded-xl text-xl shadow-xl hover:shadow-brand-pulse/20 transition-all flex items-center justify-center gap-2" href="#motion">
                <span>موشن جرافيك</span>
                <Icon name="arrow_back" />
              </a>
              <a className="w-full md:w-auto px-10 py-5 sm-glass text-brand-ink font-bold rounded-xl text-xl hover:bg-white transition-all flex items-center justify-center gap-2 border border-brand-outline" href="#ugc">
                <span>فيديوهات UGC</span>
                <Icon name="videocam" />
              </a>
            </div>
          </div>
          <div className="absolute top-1/4 left-10 w-32 h-32 bg-brand-pulse/10 blur-3xl rounded-full animate-pulse" />
          <div className="absolute bottom-1/4 right-10 w-48 h-48 bg-brand-motion/10 blur-3xl rounded-full animate-bounce" />
        </section>
