...
const SOCIAL_LINKS = [
  { href: COMPANY.social.instagram, icon: InstagramIcon, label: "انستغرام" },
  { href: COMPANY.social.tiktok, icon: TikTokIcon, label: "تيك توك" },
  { href: COMPANY.social.facebook, icon: FacebookIcon, label: "فيسبوك" },
];
